...
func (_q *GroupQuery) QueryChurch() *ChurchQuery {
...
func (_q *GroupQuery) QueryLeader() *ContactQuery {
...
func (_q *GroupQuery) QueryMembers() *ContactQuery {
	query := (&ContactClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *GroupQuery) WithChurch(opts ...func(*ChurchQuery)) *GroupQuery {
	query := (&ChurchClient{config: _q.config}).Query()
...
func (_q *GroupQuery) WithLeader(opts ...func(*ContactQuery)) *GroupQuery {
	query := (&ContactClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *GroupQuery) WithMembers(opts ...func(*ContactQuery)) *GroupQuery {
	query := (&ContactClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := _q.withChurch; query != nil {
		if err := _q.loadChurch(ctx, query, nodes, nil,
			func(n *Group, e *Church) { n.Edges.Church = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLeader; query != nil {
		if err := _q.loadLeader(ctx, query, nodes, nil,
			func(n *Group, e *Contact) { n.Edges.Leader = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *Group) { n.Edges.Members = []*Contact{} },
			func(n *Group, e *Contact) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *GroupQuery) loadChurch(ctx context.Context, query *ChurchQuery, nodes []*Group, init func(*Group), assign func(*Group, *Church)) error {
...
func (_q *GroupQuery) loadLeader(ctx context.Context, query *ContactQuery, nodes []*Group, init func(*Group), assign func(*Group, *Contact)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Group)
	for i := range nodes {
		fk := nodes[i].LeaderID
...
func (_q *GroupQuery) loadMembers(ctx context.Context, query *ContactQuery, nodes []*Group, init func(*Group), assign func(*Group, *Contact)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(contact.FieldID), joinT.C(group.MembersPrimaryKey[1]))
...
func (_q *GroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withChurch != nil {
			_spec.Node.AddColumnOnce(group.FieldChurchID)
		}
		if _q.withLeader != nil {
			_spec.Node.AddColumnOnce(group.FieldLeaderID)
		}
	}
