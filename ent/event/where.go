...
// AttendanceCount applies equality check predicate on the "attendance_count" field. It's identical to AttendanceCountEQ.
func AttendanceCount(v int) predicate.Event {
	return predicate.Event(sql.FieldEQ(FieldAttendanceCount, v))
}
...
// AttendanceCountEQ applies the EQ predicate on the "attendance_count" field.
func AttendanceCountEQ(v int) predicate.Event {
	return predicate.Event(sql.FieldEQ(FieldAttendanceCount, v))
}

// AttendanceCountNEQ applies the NEQ predicate on the "attendance_count" field.
func AttendanceCountNEQ(v int) predicate.Event {
	return predicate.Event(sql.FieldNEQ(FieldAttendanceCount, v))
}

// AttendanceCountIn applies the In predicate on the "attendance_count" field.
func AttendanceCountIn(vs ...int) predicate.Event {
	return predicate.Event(sql.FieldIn(FieldAttendanceCount, vs...))
}

// AttendanceCountNotIn applies the NotIn predicate on the "attendance_count" field.
func AttendanceCountNotIn(vs ...int) predicate.Event {
	return predicate.Event(sql.FieldNotIn(FieldAttendanceCount, vs...))
}

// AttendanceCountGT applies the GT predicate on the "attendance_count" field.
func AttendanceCountGT(v int) predicate.Event {
	return predicate.Event(sql.FieldGT(FieldAttendanceCount, v))
}

// AttendanceCountGTE applies the GTE predicate on the "attendance_count" field.
func AttendanceCountGTE(v int) predicate.Event {
	return predicate.Event(sql.FieldGTE(FieldAttendanceCount, v))
}

// AttendanceCountLT applies the LT predicate on the "attendance_count" field.
func AttendanceCountLT(v int) predicate.Event {
	return predicate.Event(sql.FieldLT(FieldAttendanceCount, v))
}

// AttendanceCountLTE applies the LTE predicate on the "attendance_count" field.
func AttendanceCountLTE(v int) predicate.Event {
	return predicate.Event(sql.FieldLTE(FieldAttendanceCount, v))
}
...
func HasChurch() predicate.Event {
...
func HasChurchWith(preds ...predicate.Church) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newChurchStep()
