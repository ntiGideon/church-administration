...
func (_q *DepartmentQuery) QueryChurch() *ChurchQuery {
...
func (_q *DepartmentQuery) WithChurch(opts ...func(*ChurchQuery)) *DepartmentQuery {
	query := (&ChurchClient{config: _q.config}).Query()
...
func (_q *DepartmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Department, error) {
	...
	if query := _q.withChurch; query != nil {
		if err := _q.loadChurch(ctx, query, nodes, nil,
			func(n *Department, e *Church) { n.Edges.Church = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *DepartmentQuery) loadChurch(ctx context.Context, query *ChurchQuery, nodes []*Department, init func(*Department), assign func(*Department, *Church)) error {
