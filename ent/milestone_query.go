...
func (_q *MilestoneQuery) QueryMember() *ContactQuery {
...
func (_q *MilestoneQuery) QueryChurch() *ChurchQuery {
...
func (_q *MilestoneQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *MilestoneQuery) FirstIDX(ctx context.Context) int {
...
func (_q *MilestoneQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *MilestoneQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *MilestoneQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *MilestoneQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MilestoneQuery) WithMember(opts ...func(*ContactQuery)) *MilestoneQuery {
	query := (&ContactClient{config: _q.config}).Query()
...
func (_q *MilestoneQuery) WithChurch(opts ...func(*ChurchQuery)) *MilestoneQuery {
	query := (&ChurchClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(milestone.FieldMilestoneType).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Milestone.Query().
//		Select(milestone.FieldMilestoneType).
//		Scan(ctx, &v)
...
func (_q *MilestoneQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Milestone, error) {
	...
	if query := _q.withMember; query != nil {
		if err := _q.loadMember(ctx, query, nodes, nil,
			func(n *Milestone, e *Contact) { n.Edges.Member = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withChurch; query != nil {
		if err := _q.loadChurch(ctx, query, nodes, nil,
			func(n *Milestone, e *Church) { n.Edges.Church = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MilestoneQuery) loadMember(ctx context.Context, query *ContactQuery, nodes []*Milestone, init func(*Milestone), assign func(*Milestone, *Contact)) error {
...
func (_q *MilestoneQuery) loadChurch(ctx context.Context, query *ChurchQuery, nodes []*Milestone, init func(*Milestone), assign func(*Milestone, *Church)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Milestone)
	for i := range nodes {
		fk := nodes[i].ChurchID
...
func (_q *MilestoneQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withMember != nil {
			_spec.Node.AddColumnOnce(milestone.FieldContactID)
		}
		if _q.withChurch != nil {
			_spec.Node.AddColumnOnce(milestone.FieldChurchID)
		}
	}
