...
func (_q *DocumentQuery) QueryChurch() *ChurchQuery {
...
func (_q *DocumentQuery) WithChurch(opts ...func(*ChurchQuery)) *DocumentQuery {
	query := (&ChurchClient{config: _q.config}).Query()
...
func (_q *DocumentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Document, error) {
	...
	if query := _q.withChurch; query != nil {
		if err := _q.loadChurch(ctx, query, nodes, nil,
			func(n *Document, e *Church) { n.Edges.Church = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DocumentQuery) loadChurch(ctx context.Context, query *ChurchQuery, nodes []*Document, init func(*Document), assign func(*Document, *Church)) error {
...
func (_q *DocumentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withChurch != nil {
			_spec.Node.AddColumnOnce(document.FieldChurchID)
		}
	}
